<<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product7.aspx.cs" Inherits="preview_dotnet_templates_portfolio_item_index" EnableEventValidation="false" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li><h4>RM160</h4></li>
                     <a href="CheckOut.aspx"><img src="Product1.aspx Files/Product7 img/BUY NOW.png" alt=""></a>
                </ul>
            </div>

<<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product3.aspx.cs" Inherits="preview_dotnet_templates_portfolio_item_index" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <!-- Custom CSS -->
    <link href="Product1.aspx Files/Product3 img/portfolio-item.css" rel="stylesheet" type="text/css" />
    <link href="Product1.aspx Files/Product3 img/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="Product1.aspx Files/Product3 img/animated.css" rel="stylesheet" type="text/css" />
					...
					<div class="col-md-6 text-center fadein scaleInv anim_2">
						<div class="text-center">
							<div class="fadein scaleInv anim_3">
								<img src="Product1.aspx Files/Product3 img/slide1-3.png" alt="" class="slide1-3 animated fadeInRightBig" >
							</div>
							<div class="fadein scaleInv anim_8">
								<img src="Product1.aspx Files/Product3 img/slide1-1.png" alt="" class="slide1-1 animated fadeInRightBig" >
							</div>
							<div class="fadein scaleInv anim_5">
								<img src="Product1.aspx Files/Product3 img/slide1-2.png" alt="" class="slide1-2 animated fadeInRightBig" >
							</div>
						</div>
					</div>
				</div>
		...
		<div class="item bg2">
			<div class="container">
				<div class="row">
                    ...
                    <br />
						<img src="Product1.aspx Files/Product3 img/slide1-4.png" alt="" style="width:90%;">
					</div>
                        ...
                        <div class="tab-featured-image">
                            <div class="tab-content">
                                <div class="tab-pane  in active" id="tab1">
                                        <img src="Product1.aspx Files/Product3 img/tab1.png" alt="tab1" class="img img-responsive">
                                </div>
                                <div class="tab-pane " id="tab2">
                                    
                                        <img src="Product1.aspx Files/Product3 img/tab2.jpg">
                                    
                                </div>
                                <div class="tab-pane fade" id="tab3">
                                    
                                        <img src="Product1.aspx Files/Product3 img/tab3.jpg" alt="tab1" class="img img-responsive">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-xs-6">
                    <img class="img-responsive portfolio-item" src="Product1.aspx Files/Product3 img/g1.png"" alt="">
                </a>
            </div>

            <div class="col-sm-3 col-xs-6">
                    <img class="img-responsive portfolio-item" src="Product1.aspx Files/Product3 img/g2.png" alt="">
                </a>
            </div>

            <div class="col-sm-3 col-xs-6">
                    <img class="img-responsive portfolio-item" src="Product1.aspx Files/Product3 img/g3.png" alt="">
                </a>
            </div>

            <div class="col-sm-3 col-xs-6">
                    <img class="img-responsive portfolio-item" src="Product1.aspx Files/Product3 img/g4.png" alt="">
                </a>
            </div>

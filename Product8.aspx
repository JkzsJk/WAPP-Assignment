<<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product8.aspx.cs" Inherits="preview_dotnet_templates_portfolio_item_index" EnableEventValidation="false" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    <li><h4>RM280</h4></li>
                     <a href="CheckOut.aspx"><img src="Product1.aspx Files/Product8 img/BUY NOW.png" alt=""></a>
                </ul>
            </div>

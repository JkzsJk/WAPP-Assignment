                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" OnClick="btnSubmit_Click1" OnClientClick="javascript:alert('Thank you for signing up, your Customer account has been registered sucessfully.');"/>
